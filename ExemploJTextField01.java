...
public class ExemploJTextField01{
	...
	public static void main(String[] args) {
		...
		botaoCalcular.setSize(200, 100);
		botaoCalcular.setLocation(40, 140);
		botaoCalcular.setFont(new Font("Magneto Negrito", 0, 26));
		botaoCalcular.setBackground(Color.decode("#353638"));
		botaoCalcular.setForeground(Color.decode("#ffffff"));
